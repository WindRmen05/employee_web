...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, " role=\"alert\">").concat(msg, "</div>");
  document.getElementById('contact').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000);
};

exports.showAlert = showAlert;
},{}],"register_api.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Employee created successfully!!");
              console.log('employee created success!!');
            } else {
              (0, _alert.showAlert)('danger', res);
            }
          ...
          case 9:
            ...
            (0, _alert.showAlert)('danger', _context.t0);
...
},{"axios":"../../../node_modules/axios/index.js","./alert":"alert.js"}],"dom_operations.js":[function(require,module,exports) {
"use strict";

var _register_api = require("./register_api.js");
...
var jobRoles = document.querySelectorAll('form .dropdown-menu a');
var jobRolesTitle = document.querySelector('form #jobroles');
var submit = document.getElementById('contact-form');
jobRoles.forEach(function (e) {
  e.addEventListener('click', function (el) {
    el.preventDefault();
    console.log(el.target.textContent);
    jobRolesTitle.firstChild.textContent = el.target.textContent; // console.log(jobRolesTitle.firstChild.textContent);
  });
});
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _alert.showAlert)('warning', 'Please complete the form and try again.');
              _context.next = 11;
              break;

            case 9:
              _context.next = 11;
              return (0, _register_api.createEmployee)({
                name: name,
                email: email,
                mobile: mobile,
                experience: exp,
                jobRole: jobRolesTitle.firstChild.textContent
              });
...
},{"./register_api.js":"register_api.js","./alert":"alert.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","dom_operations.js"], null)
